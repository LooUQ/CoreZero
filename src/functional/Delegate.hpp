...
*
******************************************************************************/
#ifndef COREZERO_DELEGATE_H
#define COREZERO_DELEGATE_H
...
namespace CoreZero
{
	...
	class Delegate <RETTy_(OBJ::*)(ARGS...)>
		: public Delegate<RETTy_(ARGS...)>
	{
		/// The signature of a member function.
		using memberDelegateType = RETTy_(OBJ::*)(ARGS...);
	...
	public:
		...
		explicit constexpr Delegate(OBJ* obj_, RETTy_(OBJ::*memberFunction)(ARGS...))
			: p_classObject(obj_)
	...
	inline Delegate<RETTy_(OBJ::*)(ARGS...)>*
		Create_MemberDelegate(OBJ* obj_, RETTy_(OBJ::* memberFunction)(ARGS...))
	{
